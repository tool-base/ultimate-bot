...
${bugReportMsg}
    ...
    Cypher.sendMessage("263781564004@s.whatsapp.net", { text: bugReportMsg, mentions: [m.sender] }, { quoted: m });
...
${requestMsg}
    ...
    Cypher.sendMessage("263781564004@s.whatsapp.net", { text: requestMsg, mentions: [m.sender] }, { quoted: m });
    Cypher.sendMessage(m.chat, { text: confirmationMsg, mentions: [m.sender] }, { quoted: m });
  }
},
  {
